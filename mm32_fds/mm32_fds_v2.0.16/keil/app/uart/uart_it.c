...
/// @version  v2.0.0
/// @date     2019-03-13
/// @brief    THIS FILE PROVIDES ALL THE UART_IT EXAMPLE.
////////////////////////////////////////////////////////////////////////////////
/// @attention
///
...
// Callback function
        ...
        .block      = emTYPE_Non_Block,     // emTYPE_Block, emTYPE_NonBlock
...
// Step 4:  Write File Device    --------------------->>>>>
        if (!txSuccess && WriteFile(hUART, 0, newTxBuffer, sizeof(newTxBuffer)) == sizeof(newTxBuffer)) {
            txSuccess = true;
            // Process Send packet
        }

// Step 5:  Read File Device    ---------------------->>>>>
        int ret = ReadFile(hUART, 0, newRxBuffer, sizeof(newRxBuffer));
