...
/// @version  v2.0.0
/// @date     2019-03-13
/// @brief    THIS FILE PROVIDES ALL THE SINGLE_TRIG EXAMPLE.
////////////////////////////////////////////////////////////////////////////////
/// @attention
///
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  The main function initializes four channels 0 of adc1, and uses
///         hardware TIM2_TRGO to trigger adc single sampling. The result of
///         sampling is passed to the array adcValue through dma, and finally
///         the result is filtered by dma interrupt mode and stored in the
///         array adcResult.
/// @param  None.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
// Step 3:  Assignment DCB structure    --------------->>>>>
    tAPP_ADC_DCB dcb = {
        ...
        .ch     = LEFT_SHIFT_BIT(0),                                            // channel: ADC_CH_n
        .temper = false,                                                        // Temperature measurement:0(DISABLE),1(ENABLE)
