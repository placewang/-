...
/// @version  v2.0.0
/// @date     2019-03-13
/// @brief    THIS FILE PROVIDES ALL THE SCAN_IT EXAMPLE.
////////////////////////////////////////////////////////////////////////////////
/// @attention
///
...
// Step 3:  Assignment DCB structure    --------------->>>>>
    tAPP_ADC_DCB dcb = {
        ...
        .dmaIt  = 0,                                                            // 0(dma interrupt disable), 1(dma interrupt enable)
        .extren = false,                                                        // External hardware trigger DISABLE
        ...
        .ch     = LEFT_SHIFT_BIT(0) | LEFT_SHIFT_BIT(1) | LEFT_SHIFT_BIT(2) | LEFT_SHIFT_BIT(3),                // channel: ADC_CH_n
