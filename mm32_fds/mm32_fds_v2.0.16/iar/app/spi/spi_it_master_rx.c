////////////////////////////////////////////////////////////////////////////////
/// @file     SPI_IT_MASTER_RX.C
/// @author   Z Yan
/// @version  v2.0.0
/// @date     2019-03-13
/// @brief    THIS FILE PROVIDES ALL THE SPI_IT_MASTER_RX EXAMPLE.
////////////////////////////////////////////////////////////////////////////////
/// @attention
///
...
// Base parameter
        ...
        .block              = emTYPE_Non_Block,         // emTYPE_Blocking, emTYPE_NonBlocking

// Callback function
        .sync               = emTYPE_Sync,          // Sync, ASync
        .cbTx       = (u32)&SYNC_SPI_TxCallback,    //tx callback function access address
        .cbRx       = (u32)&SYNC_SPI_RxCallback,    //rx callback function access address
...
// SPI parameter
    ...
    while(1){
        if(!success && ReadFile(hSPI, emFILE_SPI2, newRxBuffer, BUFFER_SIZE)){
            success = true;
            if (Buffercmp(newRxBuffer, newTxBuffer, sizeof(newTxBuffer)) == 0) {
                u8 i = 0;
                i++;
                // ... ... ...
            }
