...
/// @version  v2.0.0
/// @date     2019-03-13
/// @brief    THIS FILE PROVIDES ALL THE STANDBY EXAMPLE.
////////////////////////////////////////////////////////////////////////////////
/// @attention
///
...
// Step 3:  Open Low-power Standby Mode    --------------->>>>>
    tAPP_POWER_DCB dcb = {
    ...
    while(1) {
        if (user_Key2() || cntKey2 > 1000) {
            ...
            if (cntKey2 > 1000) {                                               // Key2 has been pressed for more than 1 seconds
                ...
                if (!user_Key2()) {                                             // If released Key2, close all Led, set RTC AlarmCounter and entering standy mode
                    vdLED = 0x00;
                    SysDisplay((u8*)&vdLED);
