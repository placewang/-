...
/// @note   Support 15.5Hz to 500KHz PWM frequency
/// @param  None.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
int main(void)
...
// Base parameter
        ...
        .mode       = emTIM_CapturePWM,     // emPWM, emCapturePulse, emCapturePWM
...
// Timer channel configure
        .ch         = emTIM_CH1,            // Now only support ch1

// Callback function
        .cbUp    = NULL,                    //NULL, (u32)&SYNC_TIM_UpdateCallback
        .cbCc    = (u32)&CCCallback,        //NULL, (u32)&SYNC_TIM_CCCallback
